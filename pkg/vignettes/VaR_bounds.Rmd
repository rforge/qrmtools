...
confidence level 99.9% for a real data set. To illustrate the ideas, we consider
as risk-factor changes the negative log-returns of the constituents of the SMI
from 2011-09-12 to 2012-03-28.

First, let's compute the risk-factor changes.
```{r}
data(SMI.12)
L <- -returns(SMI.12)
n <- nrow(L)
